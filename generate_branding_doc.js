...
const topics = [
  {
    ...
    science: [
      ['Research on speech anxiety and vocal onset', 'The physiological link between psychological state and voice quality — pitch, onset timing, breath support — is well-established in speech anxiety research. A calm speaker physically produces different vocal output than an anxious one. This is why pausing to regulate state before speaking has documented effects on delivery quality, independent of content.'],
      ['Amy Cuddy — Presence (2015, Harvard Business School)', 'Cuddy\'s research program documented how internal psychological state (calm vs anxious) alters nonverbal behaviour that listeners read before verbal content begins. Her work on "presence" — the state of being fully in the moment — describes how state regulation produces observable changes in voice and bearing.'],
...

  {
    ...
    science: [
      ['Schultz, Dayan & Montague (1997) — Science, Vol. 275, pp. 1593-1599', '"A Neural Substrate of Prediction and Reward." Recording dopamine neurons in macaque monkeys, Schultz found neurons fire when reward is unexpectedly delivered, are silent when reward is fully predicted, and dip below baseline when an expected reward is absent. The error signal — not the reward itself — drives the system. The landmark paper linking temporal-difference reinforcement learning theory to neuroscience.'],
      ...
      ['Berridge & Robinson (1998) — Brain Research Reviews, Vol. 28, pp. 309-369 (PMID: 9858756)', 'Rats with up to 99% dopamine depletion (via 6-hydroxydopamine) ceased seeking food yet showed normal hedonic responses when food was placed in their mouths. Wanting and liking are two fully dissociable brain systems. Dopamine drives wanting — not hedonic pleasure. Confirmed again in their 2016 synthesis, American Psychologist (PMID: 27977239).'],
...

  {
    ...
    science: [
      ...
      ['Montoya et al. (2017) — Psychological Bulletin, Vol. 143(5), pp. 459-498 (PMID: 28263645)', 'Meta-analysis of 268 curve estimates across 81 articles confirmed the mere exposure effect. Strongest for visual stimuli. Effect follows an inverted-U curve — peaking after moderate exposures and declining with satiation. One of the most replicated findings in social psychology.'],
...

  {
    ...
    oneLiner: 'Nalini Ambady\'s research showed that brief silent clips of a person — progressively reduced from 30 seconds down to a few seconds — predicted end-of-semester student evaluations of teachers as reliably as full-semester observation. Non-verbal behaviour speaks before words do.',
    concept: [
      'In 1993, Nalini Ambady and Robert Rosenthal published "Half a Minute: Predicting Teacher Evaluations from Thin Slices of Nonverbal Behavior" in the Journal of Personality and Social Psychology. Participants watched silent clips of teachers they had never met — clips reduced progressively from 30 seconds down to very brief exposures. When Ambady compared these ratings to end-of-semester student evaluations, the correlation was striking. Most notable: predictive accuracy from brief clips was not significantly lower than from longer ones. A few seconds of silent, non-verbal behaviour predicted a full semester of student perception.',
    ...
    science: [
      ['Ambady & Rosenthal (1993) — Journal of Personality and Social Psychology, Vol. 64(3)', '"Half a Minute: Predicting Teacher Evaluations from Thin Slices of Nonverbal Behavior." Brief silent clips of teachers — reduced progressively from 30 seconds — produced ratings that correlated significantly with end-of-semester student evaluations. The predictive accuracy from brief clips was not significantly lower than from longer ones. Malcolm Gladwell drew heavily on this research in Blink (2005).'],
      ['Willis & Todorov (2006) — Psychological Science, Vol. 17(7), pp. 592-598 (PMID: 16866745)', '"First Impressions: Making Up Your Mind After a 100-ms Exposure to a Face." Trait judgments formed after 100ms correlated strongly with unconstrained judgments on trustworthiness, competence, likeability, aggressiveness, and attractiveness. Extending exposure beyond 100ms increased confidence but did not significantly change the judgment itself.'],
    ...
    camera: [
      'Open with: "Nalini Ambady showed people a few seconds of silent video of teachers they had never met. Their ratings predicted end-of-semester student evaluations. A few seconds. No sound. No words."',
...

  {
    ...
    surprisingFact: 'Pope & Schweitzer (2011), "Is Tiger Woods Loss Averse?", published in the American Economic Review (Vol. 101, No. 1), analysed over 2.5 million putts using precise laser measurements across the PGA Tour. Golfers made par putts (avoiding a bogey — a loss) at a significantly higher rate than birdie putts (gaining a stroke) of equivalent distance and difficulty. Same green. Same player. Same skill. Only the psychological framing changed — and it changed measurable performance among the world\'s best golfers.',
    ...
    science: [
      ['Kahneman & Tversky (1979) — Econometrica, Vol. 47, pp. 263-291', '"Prospect Theory: An Analysis of Decision under Risk." People evaluate outcomes relative to a reference point (current state), not in absolute terms. The value function is steeper for losses than gains — a defining asymmetry. One of the most cited papers in economics.'],
      ['Loss aversion coefficient', 'Estimated at approximately 2:1 across studies: the subjective impact of a loss is roughly twice that of an equivalent gain. Replication studies across cultures, income levels, and decision contexts consistently confirm the asymmetry, though the exact ratio varies by context.'],
...

  {
    ...
    surprisingFact: 'Ericsson, Krampe & Tesch-Römer (1993), "The Role of Deliberate Practice in the Acquisition of Expert Performance," Psychological Review, Vol. 100, pp. 363-406: the study of elite Berlin violinists found that the top performers accumulated similar weekly practice hours to good performers — but structured their practice in focused sessions with deliberate rest in between, and slept significantly more overall. The separating variable was not more hours — it was how recovery was treated. The best performers did not grind longer. They recovered more intentionally.',
